...
let yourName = "Daniel"
let dollarAmount = "365"
let adjective = "slimey"
let noun = "goose"
let place = "supermarket"
let positiveEmotion = "elated"
let negativeEmotion = "desperation"
let sampleStory = "Today was a big day for \(yourName). They had finally saved up \(dollarAmount) dollars and were going to buy a \(adjective) \(noun). They went to the \(noun) \(place) feeling very \(positiveEmotion). But then they felt \(negativeEmotion). They were all out of \(noun)!"
//:
//:
